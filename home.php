		...
		<?php 
	      ...
	      while ($data = mysqli_fetch_array($query)) {
	 	  ...
	 	  ?>
			...
			<h5 class="text-right"><a href="?page=kaos"class="text-right" style="font-weight: bold; text-decoration: none; color: #000;">Lihat Selengkapnya...</a></h5>
		</div>
	 <!-- end kaos -->
		...
		<?php 
	      ...
	      while ($data = mysqli_fetch_array($query)) {
	 	  ...
	 	  ?>
			...
			<h5 class="text-right"><a href="?page=hoodie"class="text-right" style="font-weight: bold; text-decoration: none; color: #000;">Lihat Selengkapnya...</a></h5>
		</div>
		...
		<?php 
	      ...
	      while ($data = mysqli_fetch_array($query)) {
	 	  ...
	 	  ?>
			...
			<h5 class="text-right"><a href="?page=aksesoris"class="text-right" style="font-weight: bold; text-decoration: none; color: #000;">Lihat Selengkapnya...</a></h5>
		</div>
		<!-- end Aksesoris -->
